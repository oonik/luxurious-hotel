...
const LuxuryLiving = () => {
    return (
        <div className="hero gap-0 mt-20">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={img} alt='' className="rounded-lg  lg:w-1/2" />
                <div className='w-1/2 lg:ml-2'>
                    <h3 className='text-xl lg:text-2xl font-bold text-amber-500 mb-2'>LUXURY LIVING</h3>
                    <h1 className="text-3xl lg:text-5xl font-bold">Discover A Brand Luxurious Hotel</h1>
